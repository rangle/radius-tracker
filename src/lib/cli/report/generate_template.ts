...
// After updating the url, run `yarn cli report-generate-template`
// followed by `yarn cli report` using a sample usages database
//
...
const defaultReportUrl = "https://api.observablehq.com/@smoogly/design-system-metrics@454.tgz?v=3";
